...
export const baseStyles = {
  properties: {
    ...
    backgroundColor: {
      ...
      accentRedSecondary: theme.colors.background.accent.red.secondary,
      accentOrangeDefault: theme.colors.background.accent.orange.default,
      accentOrangeSecondary: theme.colors.background.accent.orange.secondary,
      accentYellowDefault: theme.colors.background.accent.yellow.default,
      accentYellowSecondary: theme.colors.background.accent.yellow.secondary,
      accentGreenDefault: theme.colors.background.accent.green.default,
      accentGreenSecondary: theme.colors.background.accent.green.secondary,
      accentBlueDefault: theme.colors.background.accent.blue.default,
      accentBlueSecondary: theme.colors.background.accent.blue.secondary,
      accentPurpleDefault: theme.colors.background.accent.purple.default,
      accentPurpleSecondary: theme.colors.background.accent.purple.secondary,
      accentPinkDefault: theme.colors.background.accent.pink.default,
      accentPinkSecondary: theme.colors.background.accent.pink.secondary,
    },
    borderRadius: {
      ...theme.border.radius,
    },
